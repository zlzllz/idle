...
<body>
  ...
  <section id="main" class="entire_width">
    <div class="container_12">
       <div class="grid_12">
       <h1 class="page_title">发布新商品</h1>

       <form action="<%=path %>/ProductsServlet?tag=saveA" method="post" enctype="multipart/form-data">
		<input type="hidden" name="users" value="<%=username %>"/>
        <table class="cart_product">
			<tr><th>商品名称</th><td><input type="text" name="pname"/></td></tr>
			<tr><th>商品类别</th><td><select name="types" style="width:150px">
                                    ...
                                    <option value="箱包">箱包</option></select></td>
            </tr>
			<tr><th>商品原价</th><td><input type="text" name="oldprice"/></td></tr>
			<tr><th>商品现价</th><td><input type="text" name="currentprice"/></td></tr>
			<tr><th>商品描述</th><td><textarea name="description"></textarea></td></tr>
			<tr><th>商品图片</th><td><input type="file" name="img" /></td></tr>
			<tr align="center">
				<th>操作</th>
				<td><input type="submit" value="确认发布" style="width:66px"/></td>
			</tr>
        </table>
       </form>
